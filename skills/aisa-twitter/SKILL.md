...
```bash
# User operations
python {baseDir}/scripts/twitter_client.py user-info --username elonmusk
python {baseDir}/scripts/twitter_client.py tweets --username elonmusk
python {baseDir}/scripts/twitter_client.py followers --username elonmusk
python {baseDir}/scripts/twitter_client.py followings --username elonmusk

# Search & Discovery
python {baseDir}/scripts/twitter_client.py search --query "AI agents"
python {baseDir}/scripts/twitter_client.py user-search --keyword "AI researcher"
python {baseDir}/scripts/twitter_client.py trends --woeid 1

# Post operations (requires login)
python {baseDir}/scripts/twitter_client.py login --username myaccount --email me@example.com --password xxx --proxy "http://user:pass@ip:port"
python {baseDir}/scripts/twitter_client.py post --username myaccount --text "Hello!"
python {baseDir}/scripts/twitter_client.py like --username myaccount --tweet-id 1234567890
python {baseDir}/scripts/twitter_client.py retweet --username myaccount --tweet-id 1234567890
```
