...
```bash
# Basic search
python {baseDir}/scripts/youtube_client.py search --query "AI agents tutorial"

# Search with country
python {baseDir}/scripts/youtube_client.py search --query "machine learning" --country us

# Search with language
python {baseDir}/scripts/youtube_client.py search --query "python tutorial" --lang en

# Full options
python {baseDir}/scripts/youtube_client.py search --query "GPT-5 news" --country us --lang en

# Competitor research
python {baseDir}/scripts/youtube_client.py search --query "OpenAI tutorial"

# Trend discovery
python {baseDir}/scripts/youtube_client.py search --query "AI trends 2025"
```
