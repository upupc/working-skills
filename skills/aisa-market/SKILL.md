...
python {baseDir}/scripts/market_client.py stock prices --ticker AAPL --start 2025-01-01 --end 2025-01-31
python {baseDir}/scripts/market_client.py stock prices --ticker AAPL --start 2025-01-01 --end 2025-01-31 --interval week
python {baseDir}/scripts/market_client.py stock news --ticker AAPL --count 10

# ==================== Financial Statements ====================
python {baseDir}/scripts/market_client.py stock statements --ticker AAPL --type all
python {baseDir}/scripts/market_client.py stock statements --ticker AAPL --type income
python {baseDir}/scripts/market_client.py stock statements --ticker AAPL --type balance
python {baseDir}/scripts/market_client.py stock statements --ticker AAPL --type cash

# ==================== Metrics & Analysis ====================
python {baseDir}/scripts/market_client.py stock metrics --ticker AAPL
python {baseDir}/scripts/market_client.py stock analyst --ticker AAPL

# ==================== Insider & Institutional ====================
python {baseDir}/scripts/market_client.py stock insider --ticker AAPL
python {baseDir}/scripts/market_client.py stock ownership --ticker AAPL

# ==================== SEC Filings ====================
python {baseDir}/scripts/market_client.py stock filings --ticker AAPL

# ==================== Stock Screener ====================
python {baseDir}/scripts/market_client.py stock screen --pe-max 15 --growth-min 0.2

# ==================== Interest Rates ====================
python {baseDir}/scripts/market_client.py stock rates
python {baseDir}/scripts/market_client.py stock rates --historical

# ==================== Crypto Data ====================
# Note: Use ticker format SYMBOL-USD (or just SYMBOL, auto-converted)
python {baseDir}/scripts/market_client.py crypto snapshot --ticker BTC-USD
python {baseDir}/scripts/market_client.py crypto snapshot --ticker ETH  # Auto-converts to ETH-USD
python {baseDir}/scripts/market_client.py crypto historical --ticker BTC-USD --start 2025-01-01 --end 2025-01-31
python {baseDir}/scripts/market_client.py crypto portfolio --tickers BTC-USD,ETH-USD,SOL-USD
```
